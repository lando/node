...
module.exports = {
  ...
  builder: (parent, config) =>
    class LandoNode extends parent {
      constructor(id, options = {}) {
        ...
        const node = {
          ...
          environment: {
            ...
            NODE_EXTRA_CA_CERTS: _.get(
              options,
              "_app._config.appEnv.LANDO_CA_CERT",
              "/lando/certs/LandoCA.crt"
            ),
          ...
          ports:
            options.command !== "tail -f /dev/null" && options.port !== false
              ? [options.port]
              : [],
        ...
        if (!_.isEmpty(options.globals)) {
          commands = require("../utils/get-install-commands")(
            options.globals,
            pkger,
            ["npm", "install", "-g"]
          );
