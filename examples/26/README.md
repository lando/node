...
* [Node 14-26 Service](https://docs.devwithlando.io/tutorials/node.html)
...
```bash
# Should use 26.x as the default version
lando exec defaults -- "env | grep NODE_VERSION=26."

# Should use a user specified version if given
lando exec custom -- "env | grep NODE_VERSION=26."

# Should use a user specified patch version if given
lando exec custom2 -- "env | grep NODE_VERSION=26.3.0"
